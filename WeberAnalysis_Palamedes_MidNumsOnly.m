function [WF_log]= WeberAnalysis_Palamedes_MidNumsOnly()
...
%     subj_file_sim = strcat('C:\Users\cavdaros\Desktop\MultiSensory_Final\simultaneousDany\log_files\only mid numbers\sub',num2str(subNo(s)),'.txt');
    ...
    indexes_aud_7 = find(A1_aud==B(1));
    indexes_aud_8 = find(A1_aud==B(2));
    indexes_aud_9 = find(A1_aud==B(3));
    indexes_aud_11 = find(A1_aud==B(4));
    indexes_aud_13 = find(A1_aud==B(5));
    indexes_aud_15 = find(A1_aud==B(6));
    indexes_aud = [indexes_aud_7;indexes_aud_8;indexes_aud_9;indexes_aud_11;indexes_aud_13;indexes_aud_15];
    ...
    indexes_vis_7 = find(A1_vis==B(1));
    indexes_vis_8 = find(A1_vis==B(2));
    indexes_vis_9 = find(A1_vis==B(3));
    indexes_vis_11 = find(A1_vis==B(4));
    indexes_vis_13 = find(A1_vis==B(5));
    indexes_vis_15 = find(A1_vis==B(6));
    indexes_vis = [indexes_vis_7;indexes_vis_8;indexes_vis_9;indexes_vis_11;indexes_vis_13;indexes_vis_15];
    ...
    indexes_sim_7 = find(A1_sim==B(1));
    indexes_sim_8 = find(A1_sim==B(2));
    indexes_sim_9 = find(A1_sim==B(3));
    indexes_sim_11 = find(A1_sim==B(4));
    indexes_sim_13 = find(A1_sim==B(5));
    indexes_sim_15 = find(A1_sim==B(6));
    indexes_sim = [indexes_sim_7;indexes_sim_8;indexes_sim_9;indexes_sim_11;indexes_sim_13;indexes_sim_15];
